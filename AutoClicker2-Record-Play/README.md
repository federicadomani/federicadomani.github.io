...
> Updated Oct 11 2022. New version [v5.9.4.0](index.html#ChangeLog) has been released. AutoClicker2Ex has got "Load Sequence" and "Save Sequence" buttons.
...
### Latest stable version&nbsp;{{site.app_version}}

Official Download: [Mirror 1]({{site.download_link_main}}), [Mirror 2]({{site.download_link_mirror}})
...
----- | -----
![{{site.app_name}} version {{site.app_version}}: "AutoClicker2" application](screenshots_new/v{{site.app_version}}/AutoClicker2_v5.9.4.0.png) | ![{{site.app_name}} version {{site.app_version}}: "AutoClicker2Ex" application](screenshots_new/v{{site.app_version}}/AutoClicker2Ex_v5.9.4.0.png)
...
Found a bug? Create the [issue]({{site.source_issues_url}}){:target="_blank"}!
...
The project is undergoing re-branding from "RPG AutoClicker Professional Suite for Windows" and "AutoClicker2 Record-Play for Windows" to "{{site.app_name}}". Some text labels in the application and the site may be inconsistent.
...
{{site.app_name}} {{site.app_version}} supports record, edit, debug, import, export, and playback the whole sequences of mouse clicks.
...
{{site.app_name}} is the world's top 2 mouse auto clicker application in 2022.

{{site.app_name}} is a mature mouse clicker framework for Windows that can record, save, play and randomize the whole groups/sequences/lists of mouse clicks/actions/events as well as operate with fine structures of clicking sequences to vary mouse button, time interval between clicks and much more.
...
Most important features of {{site.app_name}} are listed here.
...
* NEW. {{site.app_name}} Extended adds Fine Structure Of Clicking Sequences. It allows to record the mouse actions with different clicking buttons, time intervals, etc.
...
* {{site.app_name}} version 5.9.4.0 vs. Op AutoClicker (aka OrphamielAutoClicker) - Single Clicking Mode.

![{{site.app_name}} version 5.9.4.0 vs. Op AutoClicker (aka OrphamielAutoClicker) - Single Clicking Mode.](screenshots_new/v5.9.4.0/AutoClicker2_v5.9.4.0.png)

* {{site.app_name_ex}} version 5.9.4.0 vs. Op AutoClicker (aka OrphamielAutoClicker) - Group Clicking Mode.

![{{site.app_name_ex}} version 5.9.4.0 vs. Op AutoClicker (aka OrphamielAutoClicker) - Group Clicking Mode.](screenshots_new/v5.9.4.0/AutoClicker2Ex_v5.9.4.0.png)

* {{site.app_name_ex}} version 5.9.4.0 - Sequence of mouse clicks recorded and loaded from a text file.

![{{site.app_name_ex}} version 5.9.4.0 - Sequence of mouse clicks recorded and loaded from a text file.](screenshots_new/v5.9.4.0/AutoClicker2Ex_v5.9.4.0_seq.png)

<a name="Screenshots_v5_9_3_2"></a>
### Screenshots for previous version 5.9.3.2

* {{site.app_name}} version 5.9.3.2 - Both apps of the package together in one screen.

![{{site.app_name}} version 5.9.3.2 - Both apps of the package together in one screen.](screenshots_new/v5.9.3.1/AutoClicker2_v5.9.3.2.jpg)

* {{site.app_name}} version 5.9.3.2 - AutoClicker2: Sequence of mouse clicks recorded and loaded from a text file.

![{{site.app_name}} version 5.9.3.2 - AutoClicker2: Sequence of mouse clicks recorded and loaded from a text file.](screenshots_new/v5.9.3.1/AutoClicker2-v5.9.3.2-sequence.jpg)

### Screencast video for previous version 5.9.3.1

How to download, install and use {{site.app_name}} v5.9.3.1.

<p><iframe width="360" height="270" src="https://www.youtube.com/embed/jscqOm4OeKM?autoplay=0&rel=0" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
